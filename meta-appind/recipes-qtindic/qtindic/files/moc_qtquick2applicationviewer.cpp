...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtQuick2ApplicationViewer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QtQuick2ApplicationViewer_t qt_meta_stringdata_QtQuick2ApplicationViewer = {
    {
QT_MOC_LITERAL(0, 0, 25) // "QtQuick2ApplicationViewer"
...
QT_INIT_METAOBJECT const QMetaObject QtQuick2ApplicationViewer::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickView::staticMetaObject>(),
    qt_meta_stringdata_QtQuick2ApplicationViewer.data,
